...
echo
echo $pur"============================="$ku" ============================="
echo $i"  |"$pu"  AUTHOR    :  SANTRI_CYBER  "$i"                        |"
echo $i"  |"$pu"  WhatsApp  :  082134566596"$i"                          |"
echo $i"  |"$pu"  GMAIL     :  rayarzlost@gmail.com"$i"                  |"
echo $i"  |"$pu"  YOUTUBE   :  NGA PUNYA CUK"$i"                         |"
echo $i"  |"$pu"  INSTAGRAM :  AKKU_SANTUY"$i"                           |"
...
echo $ku"["$me"5"$ku"]"$i" locator/lacak-lokasi "
echo $ku"["$me"6"$ku"]"$i" OSIF"
echo $ku"["$me"7"$ku"]"$i" MBF"
echo $ku"["$me"8"$ku"]"$i" VIRTEX"
echo $ku"["$me"9"$ku"]"$i" DarkFB v3.3.6"
echo $ku"["$me"10"$ku"]"$i" fb-pro"
echo $ku"["$me"11"$ku"]"$i" VIRUS-lengkap"
echo $ku"["$me"12"$ku"]"$i" TOXIC-TOOLS"
echo $ku"["$me"13"$ku"]"$i" BRUTAL sms (target)"
echo $ku"["$me"14"$ku"]"$i" JADWAL SOLAT "
...
then
clear
figlet -f slant " M P S Y T " | lolcat
...
then
clear
figlet -f slant " N G R O K " | lolcat
sleep 2
pkg install wget -y
mkdir ngrok
cd ~/ngrok
...
cd ~/
echo " Ngrok nya udah ke install tuh boz ku :* "
fi

if [ $pil = 4 ]
then
clear
figlet -f slant " t x t o o l " | lolcat
sleep 1
...
then
clear
figlet -f slant " T O O L - X " | lolcat
git clone https://github.com/Rajkumrdusad/Tool-X
cd Tool-X
chmod +x *
sh install.aex
echo $ku " Tool-X sudah terinstall Bosku "
echo $ku " Tinggal ketik Tool-X untuk menjalankan nya "
fi

if [ $pil = 17 ]
then
clear
figlet -f slant " K T P " | lolcat
...
sleep 2
echo $pur"Bila Ada Kesalahan Anda Bisa Nanya Melalui Via WhatsApp"
sleep 2
echo $ku"Facebook  :"$i" SAD_BOYS_CUK"
echo $ku"Instagram :"$i" AKKU_SANTUY "
echo $ku"WhatsApp  :"$i" 082134566596"
sleep 2
